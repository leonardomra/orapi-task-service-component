...
def main():
    ...
    with app.app.app_context():
        ...
        #orcomm.addQueue(os.environ['TRAIN_SQS_QUEUE_NAME'], os.environ['TRAIN_SQS_QUEUE_ARN'], os.environ['TRAIN_SQS_QUEUE_URL'])
        #orcomm.addQueue(os.environ['PREDICT_SQS_QUEUE_NAME'], os.environ['PREDICT_SQS_QUEUE_ARN'], os.environ['PREDICT_SQS_QUEUE_URL'])
